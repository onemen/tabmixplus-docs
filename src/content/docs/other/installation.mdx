...
- Create `chrome` folder in your **Profile Folder** (if one does not exist).
...
- Extract
  ...
  Make sure all the files you see in the screenshot below are in the `utils` folder and that `utils` folder is insdie `chrome` folder.
