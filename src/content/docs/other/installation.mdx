...
**Tab Mix Plus**, or any other _legacy_ extension, you have to install 3rd party helper scripts.<br/>Visit [@xiaoxiaoflood firefox-scripts](https://github.com/xiaoxiaoflood/firefox-scripts) repository for more details.
:::
...
Visit [@xiaoxiaoflood firefox-scripts](https://github.com/xiaoxiaoflood/firefox-scripts) repository and look for updates, **OR** download the latest version:
