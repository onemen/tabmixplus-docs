...
- Floorp 11.9.0 (Notice that Floorp 11.19.1 is not compatible with Tab Mix Plus)
- LibreWolf 122+

> For **Pale Moon** download **Tab Mix Plus** from
> [here](https://addons.palemoon.org/addon/tab-mix-plus/)

[FX_FOLDER]: https://raw.githubusercontent.com/xiaoxiaoflood/firefox-scripts/master/fx-folder.zip
[UTILS_EXTENSIONS_AND_SCRIPTS]: https://raw.githubusercontent.com/xiaoxiaoflood/firefox-scripts/master/utils.zip
