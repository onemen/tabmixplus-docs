...
<ul class="topic list-disc pl-8">
  <li>
    ...
    [<b>browser.link.open_newwindow</b>](http://kb.mozillazine.org/Browser.link.open_newwindow)
...
<ul class="topic list-disc pl-8">
  <li>
    ...
    [<b>browser.link.open_newwindow.override.external</b>](http://kb.mozillazine.org/Browser.link.open_newwindow)<br />
...
<aside aria-label="Note" class="starlight-aside starlight-aside--note" style="--sl-color-bg-inline-code: #96a1f16e;">
  `JavaScript & Popup restriction` as well as `Open links that open in a new window in`
  ...
  entries.<br/><br/>
  These options control where link that uses _window.open()_ JavaScript command should be
...
<ul class="list-disc pl-8">
  <li>
    ...
    <aside aria-label="Note" class="starlight-aside starlight-aside--note">
      ...
      [regular expression](http://en.wikipedia.org/wiki/Regular_expression).<br />
