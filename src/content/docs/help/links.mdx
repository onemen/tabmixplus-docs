...
<ul class="topic list-disc pl-8">
  <li>
    Open links that open in a new window in (select one): [<b>browser.link.open_newwindow</b>
...
<ul class="topic list-disc pl-8">
  <li>
    ...
    <b>browser.link.open_newwindow.override.external</b>
    ](http://kb.mozillazine.org/Browser.link.open_newwindow) <br />
    This preference overrides browser.link.open_newwindow for external links. Set it only if you
    need different destination for external links.
    <ul class="list-disc pl-8">
      <li>New window - opens a new browser window</li>
      <li>
        <span class="default">New tab</span> - creates a new tab in the current browser window
