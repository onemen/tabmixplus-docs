...
- **_Enable undo close tabs_** <br /> previously closed tabs may be reopened and the following
  ...
  - Max number of closed tabs to remember (specify a quantity) **_default: 10 - Restore the tab's
    original position_** (tabs are restored to their position when closed)
  - Make the toolbar button display only a list

    :::note[no-title]

    <div class="grid grid-cols-[1fr,60px] gap-2">
