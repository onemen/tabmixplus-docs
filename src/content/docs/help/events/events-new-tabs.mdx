...
<ul class="topic list-disc pl-8">
  <li>
    ...
    <ul class="square list-disc pl-8">
      ...
      <li>
        Change opening order - tabs will open to the right of the most recently opened. Please refer
    ...
    <aside aria-label="Note" class="starlight-aside starlight-aside--note">
      ...
      <p>
        ...
        opening order. <br />
        `[a][b][c][1][2][3]` -&gt; `[a][1][2][3][b][c]`, this is how tabs open with the change opening
        order option checked.
      </p>
    </aside>
  </li>
</ul>
...
<div class="topic">
  ...
  <aside aria-label="Note" class="starlight-aside starlight-aside--note">
    ...
    especially when multi-process (aka E10s, [Electrolysis](https://wiki.mozilla.org/Electrolysis))
    is enabled. <br />
  ...
  <ul class="list-disc pl-8">
    ...
    <li>Don't load tabs until selected - all background tabs remain unloaded until selected.</li>
  </ul>
  <aside aria-label="Note" class="starlight-aside starlight-aside--note">
