...
- Open other tabs next to current one
  ...
  - Change opening order - tabs will open to the right of the most recently opened. Please refer to
    ...
    the new tabs opened in that order. <br /> `[a][b][c][1][2][3]` -&gt; `[a][3][2][1][b][c]`, this is
    how tabs open without _Change opening order_. <br /> `[a][b][c][1][2][3]` -&gt; `[a][1][2][3][b][c]`,
    this is how tabs open with _Change opening order_ option checked.
