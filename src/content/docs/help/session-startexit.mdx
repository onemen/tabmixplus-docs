...
<ul class="topic list-disc pl-8">
  <li>
    <h6>When not restoring on start</h6>
...
<div class="topic">
  ...
  <ul class="list-disc pl-8">
    ...
    <li>
      ...
      <aside aria-label="Note" class="starlight-aside starlight-aside--note">
        Force Firefox to download page content data from the origin server. Same as using Ctrl + F5
        or Ctrl + Shift + R to reload the selected tab overriding cache.
      </aside>
    </li>
    <li>
