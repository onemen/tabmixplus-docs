...
import eventsTabOpening from '@assets/events-tab-opening.png'
...
- Middle-click new tab button to open URLs or search for text from clipboard
  new since Firefox 115
