...
the latest test build at <a href={downloadLink()}>our Downloads page</a>).
You can reinstall the <a href={downloadLink()}>latest official version</a> in place of the development version later if you wish.
